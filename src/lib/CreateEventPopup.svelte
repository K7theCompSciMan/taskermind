...
<div
	class="flex absolute w-[75%] h-[75%] border pl-2 {dropdownDisplay} flex-col items-center ml-[12.5%] transition-opacity delay-100 bg-gray-500 rounded-2xl shadow-2xl"
>
